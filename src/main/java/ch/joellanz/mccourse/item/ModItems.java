package ch.joellanz.mccourse.item;

import ch.joellanz.mccourse.MCCourseMod;
import ch.joellanz.mccourse.util.Registration;
...
public class ModItems
{
    ...
    public enum ModArmorMaterial implements IArmorMaterial
    {
        ...
        @Override
        public float func_230304_f_() { // Knockbackresistance
    ...
    public enum ModItemTier implements IItemTier
    {
        COPPER(2, 150, 2.5f, 0f, 15,
                Ingredient.fromStacks(new ItemStack(ModItems.COPPER_INGOT.get()))); // comma if adding more materials
